...
class PV:
    def __init__(self, p_pv_rate, n_pv, phi_pv, T_num, T_set):
    ...
    def add_variables(self, model, p_pv_max):
        p_pv = model.addMVar(self.T_num, ub=p_pv_max, vtype=GRB.CONTINUOUS, name="p_pv")
        return p_pv
...
class WG:
    def __init__(self, p_wg_rate, n_wg, phi_wg, T_num, T_set):
    ...
    def add_variables(self, model, p_wg_max):
        p_wg = model.addMVar(self.T_num, ub=p_wg_max, vtype=GRB.CONTINUOUS, name="p_pv")
        return p_wg
